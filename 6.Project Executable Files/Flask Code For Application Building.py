...
final_model = joblib.load("C:/Users/akash/OneDrive/Documents/SmartBridge_Extenship/6.Project Executable Files/Application Building.pkl")
...
if __name__ == '__main__':
    # Run the Flask application
    app.run(debug=True)
>>>>>>> 8345f40e8af1f04cd54ec24d0f7f9342db8e2b71
